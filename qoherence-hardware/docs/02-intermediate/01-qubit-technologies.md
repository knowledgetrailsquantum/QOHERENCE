...
**Why cooling it down makes it work.** Ordinary metal has electrical resistance — electrons bump into the metal's atoms as they move, losing energy as heat, and that random bumping is exactly the kind of noise that would destroy a fragile quantum state almost instantly. Cool certain metals down far enough (a few hundredths of a degree above absolute zero) and something strange happens: electrons stop moving independently and instead pair up ("Cooper pairs") and flow with *zero* resistance — superconductivity. This isn't just "very cold, so slower" — it's a genuine change of behavior, first explained in 1957 by John Bardeen, Leon Cooper, and John Schrieffer (BCS theory, earning them the 1972 Nobel Prize), decades before anyone thought to build a qubit out of it. A superconducting loop, with no resistance to bleed energy away, can sustain a clean quantum state long enough to be useful — cooling isn't just about slowing noise down, it's what switches on the physical effect the whole qubit depends on.
